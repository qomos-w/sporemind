...
const CARD_ICON_COMPONENTS: LucideIcon[] = [
  ...
  // Collaboration
  Users, User, UserPlus, UserCheck, CornerUpLeft, MessageCircle, MessageSquare, Mail, Send, Link, Link2, Share2, Phone, PhoneForwarded, Video, GraduationCap,
  // System
