// @ts-nocheck — verbatim port from MentraOS render-spec-export (commit 0b3c181);
// compiled there without noUncheckedIndexedAccess. Logic is intentionally unmodified.
