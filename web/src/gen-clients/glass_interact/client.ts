...
export async function bootstrap(client: GosporeClient, req: systemTypes.GlassBootstrapReq, opts?: InvokeOptions): Promise<systemTypes.GlassBootstrapResp> {
  return client.invoke<systemTypes.GlassBootstrapReq, systemTypes.GlassBootstrapResp>("glass_interact.bootstrap", req, { reqSchemaId: 4018, resSchemaId: 4019, ...opts });
}
...
export async function debugSimulate(client: GosporeClient, req: systemTypes.GlassDebugSimulateReq, opts?: InvokeOptions): Promise<systemTypes.GlassDebugSimulateResp> {
  return client.invoke<systemTypes.GlassDebugSimulateReq, systemTypes.GlassDebugSimulateResp>("glass_interact.debug_simulate", req, { reqSchemaId: 4256, resSchemaId: 4257, ...opts });
}
...
export async function debugState(client: GosporeClient, req: systemTypes.GlassDebugReq, opts?: InvokeOptions): Promise<systemTypes.GlassDebugResp> {
  return client.invoke<systemTypes.GlassDebugReq, systemTypes.GlassDebugResp>("glass_interact.debug_state", req, { reqSchemaId: 4048, resSchemaId: 4049, ...opts });
}
...
export async function interactionReport(client: GosporeClient, req: systemTypes.GlassInteractionReportReq, opts?: InvokeOptions): Promise<systemTypes.GlassInteractionReportResp> {
  return client.invoke<systemTypes.GlassInteractionReportReq, systemTypes.GlassInteractionReportResp>("glass_interact.interaction_report", req, { reqSchemaId: 4165, resSchemaId: 4166, ...opts });
}
...
export async function sessionGetState(client: GosporeClient, req: systemTypes.GlassGetStateReq, opts?: InvokeOptions): Promise<systemTypes.GlassGetStateResp> {
  return client.invoke<systemTypes.GlassGetStateReq, systemTypes.GlassGetStateResp>("glass_interact.session_get_state", req, { reqSchemaId: 4024, resSchemaId: 4025, ...opts });
}
...
export async function speechChunk(client: GosporeClient, req: systemTypes.GlassSpeechChunkReq, opts?: InvokeOptions): Promise<systemTypes.GlassSpeechAck> {
  return client.invoke<systemTypes.GlassSpeechChunkReq, systemTypes.GlassSpeechAck>("glass_interact.speech_chunk", req, { reqSchemaId: 4027, resSchemaId: 4029, ...opts });
}
...
export async function speechEnd(client: GosporeClient, req: systemTypes.GlassSpeechEndReq, opts?: InvokeOptions): Promise<systemTypes.GlassSpeechEndResp> {
  return client.invoke<systemTypes.GlassSpeechEndReq, systemTypes.GlassSpeechEndResp>("glass_interact.speech_end", req, { reqSchemaId: 4028, resSchemaId: 4031, ...opts });
}
...
export async function speechStart(client: GosporeClient, req: systemTypes.GlassSpeechStartReq, opts?: InvokeOptions): Promise<systemTypes.GlassSpeechStartResp> {
  return client.invoke<systemTypes.GlassSpeechStartReq, systemTypes.GlassSpeechStartResp>("glass_interact.speech_start", req, { reqSchemaId: 4026, resSchemaId: 4030, ...opts });
}
...
export async function telemetryReport(client: GosporeClient, req: systemTypes.GlassTelemetryReq, opts?: InvokeOptions): Promise<systemTypes.GlassTelemetryResp> {
  return client.invoke<systemTypes.GlassTelemetryReq, systemTypes.GlassTelemetryResp>("glass_interact.telemetry_report", req, { reqSchemaId: 4208, resSchemaId: 4209, ...opts });
}
