...
export async function aggregatorConfigure(client: GosporeClient, req: systemTypes.AIManagerAggregatorConfigureReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerAggregatorConfigureResp> {
  return client.invoke<systemTypes.AIManagerAggregatorConfigureReq, systemTypes.AIManagerAggregatorConfigureResp>("aimanager.aggregator_configure", req, { reqSchemaId: 1473, resSchemaId: 1474, ...opts });
}
...
export async function aggregatorGet(client: GosporeClient, req: systemTypes.AIManagerAggregatorGetReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerAggregatorGetResp> {
  return client.invoke<systemTypes.AIManagerAggregatorGetReq, systemTypes.AIManagerAggregatorGetResp>("aimanager.aggregator_get", req, { reqSchemaId: 1475, resSchemaId: 1476, ...opts });
}
...
export async function aggregatorSetDisabled(client: GosporeClient, req: systemTypes.AIManagerAggregatorSetDisabledReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerAggregatorSetDisabledResp> {
  return client.invoke<systemTypes.AIManagerAggregatorSetDisabledReq, systemTypes.AIManagerAggregatorSetDisabledResp>("aimanager.aggregator_set_disabled", req, { reqSchemaId: 1502, resSchemaId: 1503, ...opts });
}
...
export async function configExport(client: GosporeClient, opts?: InvokeOptions): Promise<systemTypes.AIManagerConfigExportResp> {
  return client.invoke<void, systemTypes.AIManagerConfigExportResp>("aimanager.config_export", undefined, { resSchemaId: 1480, ...opts });
}
...
export async function configImport(client: GosporeClient, req: systemTypes.AIManagerConfigImportReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerConfigImportResp> {
  return client.invoke<systemTypes.AIManagerConfigImportReq, systemTypes.AIManagerConfigImportResp>("aimanager.config_import", req, { reqSchemaId: 1481, resSchemaId: 1482, ...opts });
}
...
export async function fetchOpenrouterModels(client: GosporeClient, opts?: InvokeOptions): Promise<systemTypes.AIManagerFetchOpenRouterModelsResp> {
  return client.invoke<void, systemTypes.AIManagerFetchOpenRouterModelsResp>("aimanager.fetch_openrouter_models", undefined, { resSchemaId: 5094, ...opts });
}
...
export async function listUnits(client: GosporeClient, req: systemTypes.AIManagerListUnitsReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerListUnitsResp> {
  return client.invoke<systemTypes.AIManagerListUnitsReq, systemTypes.AIManagerListUnitsResp>("aimanager.list_units", req, { reqSchemaId: 1504, resSchemaId: 1505, ...opts });
}
...
export async function modelDefaultsGet(client: GosporeClient, opts?: InvokeOptions): Promise<systemTypes.AIManagerModelDefaultsGetResp> {
  return client.invoke<void, systemTypes.AIManagerModelDefaultsGetResp>("aimanager.model_defaults_get", undefined, { resSchemaId: 5090, ...opts });
}
...
export async function modelDefaultsSet(client: GosporeClient, req: systemTypes.AIManagerModelDefaultsSetReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerModelDefaultsSetResp> {
  return client.invoke<systemTypes.AIManagerModelDefaultsSetReq, systemTypes.AIManagerModelDefaultsSetResp>("aimanager.model_defaults_set", req, { reqSchemaId: 5091, resSchemaId: 5092, ...opts });
}
...
export async function modelList(client: GosporeClient, opts?: InvokeOptions): Promise<systemTypes.ModelListResp> {
  return client.invoke<void, systemTypes.ModelListResp>("aimanager.model_list", undefined, { resSchemaId: 1465, ...opts });
}
...
export async function providerConfigure(client: GosporeClient, req: systemTypes.AIManagerProviderConfigureReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerProviderConfigureResp> {
  return client.invoke<systemTypes.AIManagerProviderConfigureReq, systemTypes.AIManagerProviderConfigureResp>("aimanager.provider_configure", req, { reqSchemaId: 1461, resSchemaId: 1462, ...opts });
}
...
export async function providerFetchModels(client: GosporeClient, req: systemTypes.AIManagerProviderFetchModelsReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerProviderFetchModelsResp> {
  return client.invoke<systemTypes.AIManagerProviderFetchModelsReq, systemTypes.AIManagerProviderFetchModelsResp>("aimanager.provider_fetch_models", req, { reqSchemaId: 1466, resSchemaId: 1467, ...opts });
}
...
export async function providerList(client: GosporeClient, opts?: InvokeOptions): Promise<systemTypes.ProviderListResp> {
  return client.invoke<void, systemTypes.ProviderListResp>("aimanager.provider_list", undefined, { resSchemaId: 1464, ...opts });
}
...
export async function providerRecordProbe(client: GosporeClient, req: systemTypes.AIManagerProviderRecordProbeReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerProviderRecordProbeResp> {
  return client.invoke<systemTypes.AIManagerProviderRecordProbeReq, systemTypes.AIManagerProviderRecordProbeResp>("aimanager.provider_record_probe", req, { reqSchemaId: 1495, resSchemaId: 1496, ...opts });
}
...
export async function providerResetHealth(client: GosporeClient, req: systemTypes.AIManagerProviderResetHealthReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerProviderResetHealthResp> {
  return client.invoke<systemTypes.AIManagerProviderResetHealthReq, systemTypes.AIManagerProviderResetHealthResp>("aimanager.provider_reset_health", req, { reqSchemaId: 1493, resSchemaId: 1494, ...opts });
}
...
export async function providerSetDisabled(client: GosporeClient, req: systemTypes.AIManagerProviderSetDisabledReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerProviderSetDisabledResp> {
  return client.invoke<systemTypes.AIManagerProviderSetDisabledReq, systemTypes.AIManagerProviderSetDisabledResp>("aimanager.provider_set_disabled", req, { reqSchemaId: 1500, resSchemaId: 1501, ...opts });
}
...
export async function providerSetTokenPlan(client: GosporeClient, req: systemTypes.AIManagerProviderSetTokenPlanReq, opts?: InvokeOptions): Promise<systemTypes.AIManagerProviderSetTokenPlanResp> {
  return client.invoke<systemTypes.AIManagerProviderSetTokenPlanReq, systemTypes.AIManagerProviderSetTokenPlanResp>("aimanager.provider_set_token_plan", req, { reqSchemaId: 1489, resSchemaId: 1490, ...opts });
}
...
export async function unitHealthList(client: GosporeClient, opts?: InvokeOptions): Promise<systemTypes.AIManagerUnitHealthListResp> {
  return client.invoke<void, systemTypes.AIManagerUnitHealthListResp>("aimanager.unit_health_list", undefined, { resSchemaId: 1499, ...opts });
}
